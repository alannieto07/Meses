...
<?php    
       include("ConexionDiciembre.php"); 

        
      $id = $_GET["id"]; 


      $sql=  $sql = "SELECT * FROM  diciembre WHERE id=$id";
...
<!--===================================-->
                <!--Ingresar productos-->
  <!--===================================--> 
  <form class="container-fluid col-6 justify-content-center text-center pt-3 " id="formulario" method="POST" action="DatosDiciembreModificado.php">    
